...
FA2_FUNGIBLE_MINIMAL = sp.io.import_script_from_script(
    "Fa2FungibleMinimal",
    """
import smartpy as sp
...
if "templates" not in __name__:
    ...
    def test():
        ...
        sp.add_compilation_target("SpaceOzInGameToken", SpaceOzInGameToken(sp.address("tz1QUYw77iqCsYUutxF511nhRhd1Z21YJKxU"), metadata_base, "https://example.com"))
        sp.add_compilation_target("TheInventoryFA2", TheInventoryFA2(sp.address("tz1QUYw77iqCsYUutxF511nhRhd1Z21YJKxU"), metadata_base, "https://example.com", ingametoken=sp.address("KT1GFjj3DCzzqAGP8nnt9Hm3rMtqem4KBAFp")))